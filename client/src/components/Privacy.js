...
const Privacy = () => {
	return (
		<div className="privacy__container">
			<h2>Privacy Policy of Bid Cape Cod</h2>
			<hr />
			<p>
				Bid Cape Cod operates the website url here, which provides the peer to
				peer purchasing of goods. This page is used to inform website visitors
				regarding our policies with the collection, use, and disclosure of
				Personal Information if anyone decided to use our Service, the website
				url here. If you choose to use our Service, then you agree to the
				...
				Conditions, which is accessible at /terms, unless otherwise defined in
				this Privacy Policy.
			</p>
			...
			<p>
				...
				but not limited to your name, phone number, and location. The
			...
			<p>
				...
				and other statistics. This is used to better develop our service and
				tailor it to the users.
			</p>
